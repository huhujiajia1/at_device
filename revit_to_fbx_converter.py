...
#CLIENT_ID = "dizwnE28B5nr3CmHYDQhq8tN7SbDOphniFvRGNSYUzKteQeP"#"5OsaD3oEFFA5J8QoASFWVyqhVhKUDzzLiWhaLcdY4anjs1AP" # 待办事项： os.getenv（"APS_CLIENT_ID"）
#CLIENT_SECRET = "s2S516oKoUVtG9E7lmJ6epynA1NCEunbAEEZdGmyChoXZGQ29JR5PZKAybo3UfAH"#WkRxIHnMvzUow64DFvXW2DPGkAV75tsE9tehqBm4mH7Vp3AtipWNdEy1FzmSnN5m" # 待办事项： os.getenv（"APS_CLIENT_SECRET"）
...
def wait_for_job(base64_urn, auth_headers, poll_max=180, poll_interval=10):
    ...
    for i in range(poll_max):
        ...
        progress = manifest.get("progress", "不适用")
